-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('ADMIN', 'MANAGER', 'SUPPORT', 'CUSTOMER');
...
CREATE TABLE "product_box_contents" (
    ...
    CONSTRAINT "product_box_contents_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "product_specs_product_id_sort_order_idx" ON "product_specs"("product_id", "sort_order");

-- CreateIndex
CREATE INDEX "product_features_product_id_sort_order_idx" ON "product_features"("product_id", "sort_order");

-- CreateIndex
CREATE INDEX "product_box_contents_product_id_sort_order_idx" ON "product_box_contents"("product_id", "sort_order");
...
-- AddForeignKey
ALTER TABLE "product_box_contents" ADD CONSTRAINT "product_box_contents_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "inventory_logs" ADD CONSTRAINT "inventory_logs_variant_id_fkey" FOREIGN KEY ("variant_id") REFERENCES "inventory"("variant_id") ON DELETE CASCADE ON UPDATE CASCADE;
